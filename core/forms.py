...
class DocumentForm(forms.Form):
    ...
    bs_name = forms.CharField(
        label="Business Name",
        widget=forms.TextInput(attrs={"required": "True", "class": "text-box"}),
    )
    ...
    addr2 = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "text-box", "autocomplete": "address-line2"}
        ),
    )
    ...
    country = forms.CharField(
        label="Country",
        widget=forms.TextInput(
            attrs={"required": "True", "class": "text-box", "autocomplete": "country"}
        ),
    )
    pincode = forms.CharField(
        label="Pincode",
        widget=forms.TextInput(
            attrs={"type": "number", "required": "True", "class": "text-box"}
        ),
    )
